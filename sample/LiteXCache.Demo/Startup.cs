...
namespace LiteXCache.Demo
{
    public class Startup
    {
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddLiteXRedisCacheWithFactory(option =>
            //{
            ...
            //    EnableLogging = false,
            //};
            //services.AddLiteXRedisCacheWithFactory(providerName: "redis", config: redisConfig);
            ...
            services.AddLiteXCacheDemoConfiguration();

            services.AddLiteXCacheSwagger();

            services.AddLiteXLogging();

			//TODO: add mvc, AddMvcWithContrller
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseLiteXCacheDemoConfiguration();
